...
<html lang="en">
  <head>
    ...
    <title>NETACAD | Network Routing</title>
              ...
              <div class="col-md-6">
                <span>
                  <ol class="breadcrumb">
                    ...
                    <li class="active">Network Routing</li>                  
                  </ol>
                </span>
              </div>
                    ...
                    <div class="col-md-2 program-list">
                      ...
                      <ul class="nav nav-tabs nav-program" role="tablist">
                        <li role="presentation" class="active">
                          <a href="#materi" aria-controls="materi" role="tab" data-toggle="tab">Mengenal Router</a>
                        </li>
                        <li role="presentation">
                          <a href="#materi2" aria-controls="materi" role="tab" data-toggle="tab">Apa itu Routing ?</a>
                        </li>
                        <li role="presentation">
                          <a href="#materi3" aria-controls="materi" role="tab" data-toggle="tab">Routing Statis</a>
                        </li>
                        <li role="presentation">
                          <a href="#materi3" aria-controls="materi" role="tab" data-toggle="tab">Routing Dinamis</a>
                        </li>
